...
int doubleSize() {
  ...
  res = (long) doubPtr2 - (long) doubPtr1;
...
int withinSameBlock(int* ptr1, int* ptr2) {
  // Your code here
  long div1 = ((long)ptr1 >> 6);
  long div2 = ((long)ptr2 >> 6);
  return div1 == div2? 1 : 0;
}
